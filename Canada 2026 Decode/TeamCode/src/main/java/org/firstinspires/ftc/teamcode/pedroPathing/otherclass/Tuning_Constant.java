...
public class Tuning_Constant {
    public static double Shooter_P_Far = 220, Shooter_I_Far = 0, Shooter_D_Far = 0, Shooter_F_Far = 11.5;
    public static double Shooter_P_Close = 100, Shooter_I_Close = 0, Shooter_D_Close = 0, Shooter_F_Close = 11.9;

    public static double testing_Shooter_Target_RPM = 2550,testing_Forward_Intake_Power =0.5, testing_Rear_Intake_Power = 0.5;
...
// ── Tx 精細模式:誤差小於門檻時切換成另一組(通常較弱/較穩)的 PID 增益 ──
    ...
    public static double Turret_Tx_Fine_Threshold_Deg_far = 2;
